...
export const metadata: Metadata = {
  title: "VITALIZE Premium Supplements | Science-Backed Wellness",
  description: "Premium supplements formulated with scientific research. Trusted by professionals. Quality ingredients. 60-day guarantee. Shop VITALIZE today.",
  keywords: "premium supplements, multivitamins, protein powder, omega-3, wellness, health supplements, fitness supplements",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "VITALIZE Premium Supplements",
    description: "Experience peak performance with our scientifically-formulated supplements",
    siteName: "VITALIZE",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764879856584-kydm83cr.jpg",
        alt: "VITALIZE Premium Supplements",
      },
    ],
  },
  twitter: {
    ...
    title: "VITALIZE Premium Supplements",
    description: "Science-backed supplements for optimal health and performance",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764879856584-kydm83cr.jpg"],
  },
};
